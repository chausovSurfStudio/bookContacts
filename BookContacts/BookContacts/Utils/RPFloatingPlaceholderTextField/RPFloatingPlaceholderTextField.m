...
- (void)adjustFramesForNewPlaceholder
{
    ...
    self.offsetFloatingLabelFrame = CGRectMake(self.originalFloatingLabelFrame.origin.x, self.originalFloatingLabelFrame.origin.y - offset - 6.0,
                                               self.originalFloatingLabelFrame.size.width, self.originalFloatingLabelFrame.size.height + 10.0);
    
    self.offsetTextFieldFrame = CGRectMake(self.originalTextFieldFrame.origin.x, self.originalTextFieldFrame.origin.y + offset + 20,
